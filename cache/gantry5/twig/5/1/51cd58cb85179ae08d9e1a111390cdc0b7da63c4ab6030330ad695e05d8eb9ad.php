...
class __TwigTemplate_51cd58cb85179ae08d9e1a111390cdc0b7da63c4ab6030330ad695e05d8eb9ad extends Twig_Template
{
    ...
    {
        // line 1
        return $this->loadTemplate((((isset($context["default"]) ? $context["default"] : null)) ? ("partials/field.html.twig") : ("forms/field.html.twig")), "forms/fields/input/fonts.html.twig", 1);
    }
    ...
    <div class=\"g-fonts\">
        ...
        echo "                    />
            ";
        // line 27
        $context["picker"] = array("field" => (("input[name=\"" . twig_escape_filter($this->env, $this->env->getExtension('UrlExtension')->fieldNameFilter(((isset($context["scope"]) ? $context["scope"] : null) . (isset($context["name"]) ? $context["name"] : null))))) . "\"]"), "data" => $this->env->getExtension('UrlExtension')->urlFunc("gantry-admin://js/google-fonts.json"), "local" => (isset($context["map"]) ? $context["map"] : null));
        // line 28
        echo "            <span class=\"input-group-btn\">
                <button class=\"button\" type=\"button\" data-g5-fontpicker=\"";
        // line 29
