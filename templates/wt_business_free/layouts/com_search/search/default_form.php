...
$block_config = $warp['config']->get('block');

$wrapper = '';
if (array_key_exists('block-fullwidth', $block_config['main']) && $block_config['main']['block-fullwidth'] == '1') {
	$wrapper .= ' uk-container uk-container-center';
}
if ($block_config['main']['block-padding'] == ' tm-block-padding-collapse') {
	$wrapper .= ' uk-margin-large';
}
