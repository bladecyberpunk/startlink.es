...
function fontChooser($fontfamily)
{
	...
	switch($fontfamily)
	{
		...
		case 'Numans':
			...
			break;	
		case 'Open Sans':
			$font_arr['fontlink'] = "<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic&subset=latin,cyrillic,greek' rel='stylesheet' type='text/css'>";
			$font_arr['fontfamily'] = "font-family: 'Open Sans', sans-serif;";
			break;	
		case 'Oxygen':
